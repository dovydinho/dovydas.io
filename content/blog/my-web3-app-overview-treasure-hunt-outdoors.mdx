...
To list a new cache, user must connect to Metamask and have Ropsten Test Network selected. Some amount of Ropsten Ether should be available in the wallet to complete the transaction.
