...
An open orderbook shows all active orders on the exchgange.
...
Tokens for active limit orders are subtracted from the wallet and are not available for withdrawl.
...
- Fullfilled orders are removed from the orderbook.
...
- Order book is sorted for BUY and SELL orders appropriately.

<InformationalText>
  Explore smart contract on Etherscan:&nbsp;
  <a
    href="https://ropsten.etherscan.io/address/0xE3304B555607eA326E7Ba77a3C56aD9820dCc0f2"
    target="_blank"
  >
    0xE3304B555607eA326E7Ba77a3C56aD9820dCc0f2
  </a>
</InformationalText>
...
There have been a total of 18 smart contract tests written and asserted for this application:
...
Financial applications should adopt only the highest quality code with thorough testing to minimize risk for potential malitious acts.
