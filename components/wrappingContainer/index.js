  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:url" content="https://dovydas.io" />
      ...
      <div className="flex flex-col justify-center px-8">
        <nav className="flex items-center justify-between w-full relative max-w-4xl border-gray-200 dark:border-gray-700 mx-auto pt-8 pb-8 sm:pb-16">
          ...
          <div className="ml-[-0.60rem]">
            ...
            <NextLink href="https://www.linkedin.com/in/dovydas-lapinskas">
              <a
                target="_blank"
                className="p-1 sm:px-2 sm:py-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-800 transition-all"
              >
                <svg
            ...
            <NextLink href="https://twitter.com/dovydinho">
              <a
                target="_blank"
                className="p-1 sm:px-2 sm:py-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-800 transition-all"
              >
